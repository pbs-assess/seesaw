...
Despite these issues, analysts often seek an index of abundance that represents the full survey or a stock-domain across multiple surveys.
Model-based index standardization over an expanded spatial domain offers a potential solution.
However, we show here that in practice this can produce unrealistic interannual oscillations, which we term ``seesaw'' effects.
